      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {cards.map((card, index) => (
            <div
              key={index}
              className="group bg-black/25 backdrop-blur-sm rounded-xl p-6 border border-[#F5F9FC]/12 hover:border-[#26C6DA] transition-all duration-500 hover:scale-105"
            >
              <div className="bg-black/30 rounded-lg h-48 mb-4 flex items-center justify-center">
