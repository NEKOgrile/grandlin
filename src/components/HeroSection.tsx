  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
      <div
        ...
        style={{ opacity }}
      >
        <div className="absolute inset-0 bg-gradient-to-b from-[#A8E6F5] via-[#3BA5D0] to-[#1E81B0]" />
        <div className="absolute bottom-0 w-full h-48 bg-gradient-to-t from-[#3BA5D0]/40 to-transparent animate-pulse" />
      </div>
